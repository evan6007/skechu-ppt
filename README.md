...
- **Deep-learning architecture diagrams:** open **架構圖** for five editable research-figure templates and six reusable vector components, including CNN feature-map stacks, attention, U-Net, diffusion and tensor grids. Templates open on a new page; components insert into the current page with one-step Undo. [Diagram guide](docs/deep-learning-diagrams.md).
