...
- **Deep-learning architecture diagrams:** open **架構圖** to build editable 3D feature-map cuboids with adjustable camera angle, dimensions, layers and labels. Insert a stack on the current page or create a six-stage CNN example. Five other layouts and six reusable vector components cover attention, U-Net, diffusion and tensor grids. [Diagram guide](docs/deep-learning-diagrams.md).
