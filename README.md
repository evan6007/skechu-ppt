...
<table>
  ...
  <tr>
    ...
    <td width="50%"><img src="docs/media/feature-powerpoint.gif" alt="The brain is pasted into PowerPoint, fully selected, then its independent colored regions spread along a full-slide S curve"><br><strong>Native PowerPoint objects</strong> — paste the brain, select every object, and spread its editable color regions across the slide.</td>
  </tr>
</table>
