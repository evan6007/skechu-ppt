...
for(const marker of ['--surface','--canvas-desk','--glass-surface','--range-track','.stage-shell{position:relative','data-ui-theme="graphite"','theme-controls.js?v=46-canvas-shapes','theme-controls.css?v=50-mobile-github-actions','fill-opacity:.3','.action-menu-popover{position:fixed','input[type="range"]::-webkit-slider-runnable-track','grid-template-rows:48px minmax(0,1fr) 62px'])assert.ok(css.includes(marker)||html.includes(marker),'Missing theme marker '+marker);
