...
assert.ok(gifBuilder.includes('auto_canvas_match_bounds = (0.166, 0.134, 0.813, 0.763)')&&gifBuilder.includes('auto_preview_match_bounds = (0.212, 0.308, 0.790, 0.872)')&&gifBuilder.includes('zoom_sequence(auto_imported_source, auto_bounds, auto_canvas_match_bounds, 8)')&&gifBuilder.includes('tween(auto_imported_match, auto_preview_match, 5)')&&gifBuilder.includes('zoom_sequence(auto_preview_source, auto_bounds, auto_preview_match_bounds, 8)')&&gifBuilder.includes('zoom_sequence(auto_applied_source, auto_canvas_match_bounds, auto_bounds, 8)'),'Auto trace modal must zoom from the source brain into its matched preview and reverse the same spatial transition back to the unchanged canvas brain');
