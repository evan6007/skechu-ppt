...
assert.ok(gifBuilder.includes('auto_preview_close_bounds = (0.452, 0.574, 0.682, 0.780)')&&gifBuilder.includes('zoom_sequence(auto_preview_source, auto_bounds, auto_preview_close_bounds, 12)')&&gifBuilder.includes('"複雜線條完整描出", auto_preview_close')&&gifBuilder.includes('range(36)'),'Auto trace demo must center, enlarge and raise the complex cerebellum tracing long enough to inspect it');
