...
assert.ok(browserCapture.includes('motionOrder')&&gifBuilder.includes('crop_width = min(760')&&gifBuilder.includes('anchor=anchor')&&gifBuilder.includes('吸住邊緣來回滑動'),'Magnetic tracing demo must use a close view and clearly show the snapped point moving along the edge');
