...
assert.ok(pptCapture.includes('rank_by_index')&&pptCapture.includes('for step in range(49)'),'PowerPoint color regions must expand clockwise in a smooth sequence around the slide');
