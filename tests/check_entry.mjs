...
assert.ok(gifBuilder.includes('"描圖已套用", auto_applied')&&gifBuilder.includes('range(10)'),'Auto trace demo must pause after applying the trace before shrinking the reference image');
