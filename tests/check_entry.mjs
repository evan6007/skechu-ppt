...
assert.ok(gifBuilder.includes('"預覽描圖結果", auto_preview')&&gifBuilder.includes('range(36)'),'Auto trace demo must hold the generated preview long enough to inspect it');
