...
assert.ok(gifBuilder.includes('zoom_sequence(auto_preview_source, auto_bounds, auto_preview_close_bounds, 12)')&&gifBuilder.includes('"局部確實沿線描邊", auto_preview_close')&&gifBuilder.includes('range(36)'),'Auto trace demo must zoom into and hold a local traced edge long enough to inspect it');
