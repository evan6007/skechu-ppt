...
assert.ok(html.includes('workspace-page-ghost')&&html.includes('workspace-actions.js?v=89-file-save'));assert.ok(worker.includes('workspace-actions.js?v=89-file-save'));
