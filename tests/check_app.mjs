...
for(const file of ['editor-render.js','gradient-regions.js','auto-trace.js','auto-trace-ui.js','auto-trace-worker.js','auto-trace.css','compound-fill.js','paint-layers.js','paint-tools.js','paint-tools.css','pan-tool.js','selection-controls.js','workspace-actions.js','layer-controls.js','layer-controls.css','panel-layout.js','theme-controls.js','theme-controls.css','clipboard-controls.js','web-ppt-client.js','web-ppt-helper.js','web-ppt.html','ppt-preparation.js','clipboard-controls.css']){
  const asset=fs.readFileSync(new URL('../app/'+file,import.meta.url),'utf8');
  if(file.endsWith('.js'))new Function(asset);
