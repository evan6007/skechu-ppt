...
for(const file of ['auto-trace.js','auto-trace-ui.js','auto-trace-worker.js','auto-trace.css','paint-layers.js','paint-tools.js','paint-tools.css','pan-tool.js','selection-controls.js','clipboard-controls.js','clipboard-controls.css']){
